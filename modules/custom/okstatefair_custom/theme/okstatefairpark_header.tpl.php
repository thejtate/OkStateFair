...
<header class="header">
  <div class="wrapper">
    <a href="/#state-fair-park" class="logotype">                
      <div class="logo"></div>
      <div class="type">
    ...
    <nav class="navigation">
      <div class="block-right">
         <div class="block-inner"><?php print theme('image', array('path' => drupal_get_path('theme',$GLOBALS['theme']) . '/images/tmp/_img_title_event.png')); ?></div>
      </div>
      <?php print($items); ?>
    </nav>
  </div>
