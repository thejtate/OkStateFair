...
<?php print l('<div class="inner"><div class="arrow"></div></div>', '/#oklahoma-state-fair', array(
  'html' => TRUE,
  'external' => TRUE,
  'attributes' => array('class' => array('btn-full-right-2'))
)); ?>