...
<div class="content-item item-odd">
  ...
  <div class="share-wrapper social-type">
    <?php if(!empty($node->field_sfp_event_locations[LANGUAGE_NONE])):  ?>
        ...
        <?php if (isset($val['taxonomy_term']->field_location_front_name) && !empty($val['taxonomy_term']->field_location_front_name[LANGUAGE_NONE][0]['value'])) :
          ...
          <?php if( !empty($val['taxonomy_term']->field_field_location_map_smaller[LANGUAGE_NONE][0]['uri'])): ?>
            <?php print l($loc_title, file_create_url($val['taxonomy_term']->field_field_location_map_smaller[LANGUAGE_NONE][0]['uri']), array('external' => TRUE, 'attributes' => array('class' => array('link-where')))); ?>
          <?php else: ?>
  ...
  <div class="share-wrapper social-type">
    ...
    <ul class="share-list type-share-2">
