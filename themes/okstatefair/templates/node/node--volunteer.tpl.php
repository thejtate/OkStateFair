...
<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <?php print render($content['field_volunteer_top_content']); ?>
  <div class="content-wrapper odd">
    <?php print render($content['field_volunteer_right_images']); ?>
    <?php print render($content['field_volunteer_content']); ?>
  </div>
  <?php
