      ...
      <div class="body">
        ...
        <div class="body-inner">
          <div class="body-content">
            ...
            <?php endif; ?>
            <?php if (isset($node) && ((isset($chickasaw_nodes) && in_array($node->nid, $chickasaw_nodes)) || in_array($node->nid, private_events()) || $node->nid == XTREME_BULLS)) : ?>
              <div class="title-promo">
                <div class="logo-promo">
                  <?php print theme('image', array('path' => path_to_theme() . '/images/' . $promo_image)); ?>
                </div>
              </div>
            <?php elseif (isset($node) && $node->nid == DISNEP_NID) : ?>
